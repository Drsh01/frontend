...
export default function UpdateItem() {
    ...
    const [itemStatus, setItemStatus] = React.useState(status[0]);
    const [itemValue, setItemValue] = React.useState('');

    const handleSubmit = () => {
        console.log(itemDescription, itemMakeValue, itemCategory,itemStatus,itemValue);
    }
        ...
        <div className="container text-center" style={{ marginTop: "120px" }}>
            ...
            <form className="border col-xs-12 col-sm-10 col-8 mx-auto">
                ...
                <div className="form-outline form-inline mb-4 col-6">
                    ...
                    <select className="select col-xs-8 col-sm-6 col-4" onChange={(e) => setItemStatus(e.target.value)} >
                ...
                <button type="button" className="btn btn-success btn-block col-3 mb-4" onClick={handleSubmit}>Update Item</button>
            </form>
        </div>
    );
}